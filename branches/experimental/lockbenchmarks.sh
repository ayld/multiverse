...
runbenchmark '{"benchmarkName":"baseline/locks/ReentrantLock/unfair","driverClass":"org.multiverse.benchmarks.drivers.oldschool.locks.ContendedReentrantLockDriver",
	"testcases":[
...
runbenchmark '{"benchmarkName":"baseline/locks/ReentrantLock/fair","driverClass":"org.multiverse.benchmarks.drivers.oldschool.locks.ContendedReentrantLockDriver",
	"testcases":[
...
createDiagram 'baseline/locks/ReentrantLock/fair;baseline/locks/ReentrantLock/unfair;baseline/locks/IntrinsicLock' 'threadCount' 'transactions/second'
gnuplot <<< '
...
createDiagram 'baseline/locks/ReentrantLock/unfair;baseline/locks/IntrinsicLock' 'threadCount' 'transactions/second'
gnuplot <<< '
