...
public class AtomicObject_MethodTest {
    ...
    public void atomicObjectAsArgumentProblem() {
        //todo: a problem should be expected.
        //the methods contain arguments of type atomic object.
    ...
    static class AtomicObjectArgProblem {
        ...
        public void method2(AtomicObjectArgProblem intRef) {

        }

        public void method1(AtomicObjectArgProblem intRef) {
            intRef.method2(this);
        }
    }
}
