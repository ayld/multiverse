...
/**
 * A snapshot of a {@link AlphaTranlocal}. This can be used to make a snapshot and restore an Tranlocal
...
public abstract class AlphaTranlocalSnapshot {
    ...
    /**
     * Each {@link AlphaTranlocalSnapshot} can also be used as a single linked list. Normally
     ...
     */
    public AlphaTranlocalSnapshot next;
