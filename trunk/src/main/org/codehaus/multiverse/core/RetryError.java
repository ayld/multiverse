 ...
 * caught.
 * <p/>
 * Although the actual exception handling is not very expensive, creating the stacktrace inside the transaction
 ...
 * to make the STM completely transparant, this is needed.
 *
